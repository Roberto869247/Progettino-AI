;;Shakey deve inserire 21 forme di tetris ordinandole su 5 piani differenti
;;l'ultimo piano potrà essere formato soltanto dall'ultima forma rimasta

(define (problem shakey-task-4)
            (:domain shakey)
            (:objects
                ;; static:
                ...
                tetris-piece12 tetris-piece13 tetris-piece14 tetris-piece15 tetris-piece16 tetris-piece17 tetris-piece18 tetris-piece19 tetris-piece20 tetris-piece21
                ;; container level
                v0 v1 v2 v3
            )
            (:init
                ...
                (inc v0 v1) (inc v1 v2) (inc v2 v3)
                (dec v1 v0) (dec v2 v1) (dec v3 v2)
                ...
                (form4 tetris-piece7) (form4 tetris-piece8) (form4 tetris-piece21)
